 ...
 * Use this as a wrapper around Element.animate() to prevent errors
 * 
 ...
 */
export const safeAnimate = (element, keyframes, options) => {
  ...
  if (safeOptions.easing && safeOptions.easing.includes('cubic-bezier')) {
